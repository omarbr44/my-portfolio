<template>
    <div class="flex lg:flex-row flex-col bg-site-primary" v-if="id == 1">
        <div class="basis-2/3 sm:order-2 md:order-2">
            <img src="../assets/lib1.jpg" loading="lazy" class=" w-full " alt="">
            <img src="../assets/lib2.jpg" loading="lazy" class=" w-full " alt="">
            <img src="../assets/lib3.jpg" loading="lazy" class=" w-full " alt="">
        </div>
        <div class="lg:p-16 md:p-12 sm:p-10 lg:fixed lg:w-1/3 right-0">
            <p class="header-line lg:text-5xl md:text-4xl sm:text-3xl text-white text-center [text-shadow:1px_2px_3px_black]">تطوير مواقع</p>
            <div class="flex justify-end my-6 ">
            <svg fill="#fff" width="40px" height="40px" viewBox="0 0 24 24" class="ml-2" xmlns="http://www.w3.org/2000/svg">
                <title>ps</title>
            ...
            <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" class="ml-2" xmlns="http://www.w3.org/2000/svg">
            <path d="M19.1143 2H15L12 6.9L9.42857 2H0L12 23L24 2H19.1143ZM3 3.75H5.91429L12 14.6L18.0857 3.75H21L12 19.5L3 3.75Z" fill="#fff"/>
            </svg>
            <svg fill="#fff" width="40px" height="40px" class="ml-2" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <title>laravel</title>
    ...
    <div class="flex lg:flex-row flex-col bg-site-primary" v-if="id == 3">
        <div class="basis-2/3 sm:order-2 md:order-2">
            <img src="../assets/todo1.jpg" loading="lazy" class=" w-full " alt="">
            <img src="../assets/todo2.jpg" loading="lazy" class=" w-full " alt="">
        </div>
        <div class="lg:p-16 md:p-12 sm:p-6 lg:fixed lg:w-1/3 right-0">
            <p class="header-line lg:text-5xl md:text-4xl sm:text-3xl text-white text-center [text-shadow:1px_2px_3px_black]">تطوير مواقع</p>
            <div class="flex justify-end my-6 ">
            ...
            <h3 class="text-4xl sm:text-2xl text-white text-end"> سجل مهامك</h3>
            <p class="text-lg text-site-secondary text-end"> سجل مهامك هو عمل شخصي لتسجيل جميع مهام اليوم وتسجيل التي لم يتم عملها بعد للتذكير</p>
        </div>
    </div>

    <div class="flex lg:flex-row flex-col bg-site-primary" v-if="id == 4">
        <div class="basis-2/3 sm:order-2 md:order-2">
            <img src="../assets/web1.jpg" loading="lazy" class=" w-full " alt="">
            <img src="../assets/web2.jpg" loading="lazy" class=" w-full " alt="">
            <img src="../assets/web3.jpg" loading="lazy" class=" w-full " alt="">
        </div>
        <div class="lg:p-16 md:p-12 sm:p-6 lg:fixed lg:w-1/3 right-0">
            <p class="header-line lg:text-5xl md:text-4xl sm:text-3xl text-white text-center [text-shadow:1px_2px_3px_black]">تطوير مواقع</p>
            <div class="flex justify-end my-6 ">
            ...
            <h3 class="text-4xl sm:text-2xl text-white text-end"> الأيواء السياحي</h3>
            <p class="text-lg text-site-secondary text-end"> مشروع خاص بجهة سياحية لتسهيل العمل على المالك وجميع مايتعلق بالسياحة من فنادق وشاليهات وغيره</p>
            <div class="flex justify-end my-6 ">
                <a href="https://github.com/omarbr44/AlatiqaHotel/" class="text-white flex ml-4">
                    <svg width="30px" height="30px" viewBox="0 0 50 50" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg"><defs></defs><path class="cls-1" d="M24,2.5a21.5,21.5,0,0,0-6.8,41.9c1.08.2,1.47-.46,1.47-1s0-1.86,0-3.65c-6,1.3-7.24-2.88-7.24-2.88A5.7,5.7,0,0,0,9,33.68c-1.95-1.33.15-1.31.15-1.31a4.52,4.52,0,0,1,3.29,2.22c1.92,3.29,5,2.34,6.26,1.79a4.61,4.61,0,0,1,1.37-2.88c-4.78-.54-9.8-2.38-9.8-10.62a8.29,8.29,0,0,1,2.22-5.77,7.68,7.68,0,0,1,.21-5.69s1.8-.58,5.91,2.2a20.46,20.46,0,0,1,10.76,0c4.11-2.78,5.91-2.2,5.91-2.2a7.74,7.74,0,0,1,.21,5.69,8.28,8.28,0,0,1,2.21,5.77c0,8.26-5,10.07-9.81,10.61a5.12,5.12,0,0,1,1.46,4c0,2.87,0,5.19,0,5.9s.39,1.24,1.48,1A21.5,21.5,0,0,0,24,2.5"/></svg>   
                </a>
            </div>
        </div>
...
<style>
.cls-1{fill:#fff;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;fill-rule:evenodd;}
h1,h2,h3,h4,h5{
